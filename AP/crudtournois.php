	...
	<main>
		...
		<table width='80%' border=0>
	    	...
	    	while ($res = $stmt->fetch(PDO::FETCH_ASSOC)) {
            	...
            	<a href=\"deletetournois.php?id=".$res['id']."\" onClick=\"return confirm('Êtes vous sur de vouloir supprimer ?')\">Supprimer</a> | 
				<a href=\"crudinscriptions.php?id=".$res['id']."\">Inscriptions</a></td>";
        	}
